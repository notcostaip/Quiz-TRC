    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(errData.error || 'Erro ao registrar.');
            }
        } catch (err) {
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="bg-[#0f0f0f] border border-neutral-800/80 rounded-[28px] p-8 sm:p-10 shadow-lg">
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-3 text-[#A1A1AA] font-medium text-[15px]">Crie sua conta para acessar a plataforma.</p>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                                    <svg className="w-5 h-5 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                </div>
                                <input
                                    id="fullName"
                                    type="text"
                    ...
                    <div className="mt-8 text-center pt-2 border-t border-neutral-800/50">
                        <p className="text-neutral-500 text-sm mt-6">
                            Já possui uma credencial? <Link href="/login" className="text-white hover:text-neutral-300 font-medium transition-colors">Entrar no Sistema</Link>
                        </p>
                    </div>
                </div>
            </div>
